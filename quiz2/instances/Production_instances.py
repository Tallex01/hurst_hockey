...
def create_production_instances():
    """
    Read Production.csv and create a list of Production instances.

    Returns:
        list: A list of Production objects populated from the CSV file
    """
    instances = []
    csv_path = Path(__file__).resolve().parent.parent / "groups" / "Production.csv"
