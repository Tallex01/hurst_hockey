...
def create_healthcare_instances():
    """
    Read Healthcare.csv and create a list of Healthcare instances.

    Returns:
        list: A list of Healthcare objects populated from the CSV file
    """
    instances = []
    csv_path = Path(__file__).resolve().parent.parent / "groups" / "Healthcare.csv"
