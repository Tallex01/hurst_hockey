...
def create_sales_instances():
    """
    Read Sales.csv and create a list of Sales instances.

    Returns:
        list: A list of Sales objects populated from the CSV file
    """
    instances = []
    csv_path = Path(__file__).resolve().parent.parent / "groups" / "Sales.csv"
