...
def create_legal_instances():
    """
    Read Legal.csv and create a list of Legal instances.

    Returns:
        list: A list of Legal objects populated from the CSV file
    """
    instances = []
    csv_path = Path(__file__).resolve().parent.parent / "groups" / "Legal.csv"
